...
@InputType()
class ShipmentCreateNestedManyWithoutCustomersInput {
...
export { ShipmentCreateNestedManyWithoutCustomersInput as ShipmentCreateNestedManyWithoutCustomersInput };
